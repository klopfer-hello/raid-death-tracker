...
- Raid timer: starts on the first pull in a raid instance, shows elapsed time in the panel and records each boss kill with time since raid start and fight duration
...
- The raid time counts live while you are inside the instance; once you leave, it freezes at the moment of the **last boss kill** (first pull → last boss). Pulling in a different raid instance starts a fresh timer.
